<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'header',
        'desc'             => __( 'Manage theme header', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
                array(
                    ...
                    'compiler' => 'true',
                    'desc'     => __( 'Add/Edit logo', 'redux-framework-demo' ),
                ),
                array(
                    'id'       => 'favicon',
                    'type'     => 'media',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'footer',
        'desc'             => __( 'Manage theme About', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-edit'
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Manage your About', 'redux-framework-demo' ),
        'fields'           => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'contact',
        'desc'             => __( 'Manage theme contact', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-edit'
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Manage your contact information', 'redux-framework-demo' ),
        'fields'           => array(
                array(
                    'id'       => 'address',
                    'type'     => 'text',
    ...
    //     'subsection'       => true,
    //     'customizer_width' => '450px',
    //     'desc'             => __( 'Manage your social links', 'redux-framework-demo' ),
    //     'fields'           => array(
    //             array(
    //                 'id'       => 'facebook',
    //                 'type'     => 'text',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Manage your Google Map', 'redux-framework-demo' ),
        'fields'           => array(
